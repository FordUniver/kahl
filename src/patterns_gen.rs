...
// Generated: 2026-01-21T10:10:33Z
...
// Entropy detection configuration from entropy.yaml

pub const ENTROPY_ENABLED_DEFAULT: bool = false;

/// Entropy thresholds by character set
pub const ENTROPY_THRESHOLD_HEX: f64 = 3.0;
pub const ENTROPY_THRESHOLD_BASE64: f64 = 4.5;
pub const ENTROPY_THRESHOLD_ALPHANUMERIC: f64 = 4.5;

/// Token length constraints
pub const ENTROPY_MIN_LENGTH: usize = 16;
pub const ENTROPY_MAX_LENGTH: usize = 256;

/// Entropy exclusion pattern
#[derive(Debug, Clone)]
pub struct EntropyExclusion {
    pub pattern: &'static str,
    pub label: &'static str,
...
/// Exclusion patterns for entropy detection
pub const ENTROPY_EXCLUSIONS: &[EntropyExclusion] = &[
    EntropyExclusion {
    ...
    EntropyExclusion {
        ...
        label: "MD5_HASH",
        case_insensitive: false,
        context_keywords: Some(&["md5", "hash", "checksum", "etag"]),
    },
    EntropyExclusion {
