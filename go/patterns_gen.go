...
// Generated: 2026-01-09T19:42:06Z
...
const EntropyEnabledDefault = false
const EntropyMinLength = 16
const EntropyMaxLength = 256

// EntropyThresholds maps charset names to entropy thresholds
...
// EntropyExclusion defines a pattern to exclude from entropy detection
...
// EntropyExclusions lists patterns to exclude from entropy detection
var EntropyExclusions = []EntropyExclusion{
	{
	...
	},
	{
		...
		ContextKeywords: []string{"commit", "sha", "hash", "ref", "oid", "blob", "tree", "parent", "HEAD", "merge"},
	},
	{
		Pattern:         "[a-f0-9]{64}",
		Label:           "SHA256_HASH",
		CaseInsensitive: false,
		ContextKeywords: []string{"sha256", "image", "docker", "digest", "hash", "checksum", "layer"},
	},
	{
		Pattern:         "[a-f0-9]{32}",
		Label:           "MD5_HASH",
		CaseInsensitive: false,
		ContextKeywords: []string{"md5", "hash", "checksum", "etag"},
	},
	{
...
// EntropyContextKeywords is a map for quick keyword lookup
